...
while True:
    ...
    angleDeg = angleDeg/180 * 100        
 
    cv2.rectangle(img, (50, 150), (85, 400), (175, 155), 3)
    cv2.rectangle(img, (50, int(angleBar)), (85, 400), (255, 0, 0), cv2.FILLED)
    cv2.putText(img, f'naik/turun {int(angleDeg)}%', (40, 530), cv2.FONT_HERSHEY_COMPLEX_SMALL, 
                2, (160, 9, 195), 3)
 
    cv2.imshow("Volume tangan", img)
    cv2.waitKey(1)